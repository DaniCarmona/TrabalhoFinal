...
import pt.ipg.trabalhofinal.databinding.FragmentListaDosesBinding
...
class ListaDosesFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    fun navegaMenuPrincipal() {
        findNavController().navigate(R.id.action_listaDosesFragment_to_menuPrincipalFragment)
    }
    ...
    override fun onCreateLoader(id: Int, args: Bundle?): Loader<Cursor> {
        return CursorLoader(
            ...
            null, null,
            TabelaDoses.CAMPO_EXTERNO_NOME_UTENTE
        )
    }
